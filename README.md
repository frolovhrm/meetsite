Учебный проект. Реализация идеи менеджера переговорок с автоматическим распределением заявок по комнатам с учетом заявленных параметров и доступных ресурсов.
